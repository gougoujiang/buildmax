...
| [Local background jobs](local-background-jobs.md) | P0.5 | Stage 1 shipped: background `Bash` jobs, `Job` tools, TUI `/tasks`, Desktop drawer. Subagents, monitors, and durability open |
