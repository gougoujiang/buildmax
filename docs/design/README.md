...
| [Local background jobs](local-background-jobs.md) | P0.5 | Stages 1–2 shipped: background `Bash` and `Task` jobs, `Job` tools, trace linkage, TUI `/tasks`, Desktop drawer. Monitors and durability open |
