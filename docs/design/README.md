...
| [Evaluation and qualification](evaluation-system.md) | P0.6 | Direction accepted and the vertical slice broken into ordered increments, with the trace audit and adapter sketch it depends on; contract and slice not implemented |
