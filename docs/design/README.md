...
| [Local Ollama provider](local-ollama-provider.md) | P1 follow-on | Phases 1–2 shipped: the adapter, local inventory, and the CLI surface. Managed catalog targets deferred |
