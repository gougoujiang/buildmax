...
| [Local background jobs](local-background-jobs.md) | P0.5 | Stages 1–3 shipped: background `Bash`/`Task` jobs, `Monitor`, typed event delivery with TUI wake-up. Desktop wake-up and stage 4 durability open |
