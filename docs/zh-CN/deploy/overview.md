...
> **翻译说明：** 本文是[英文原文](../../deploy/overview.md)的简体中文派生翻译。**同步依据：** 英文原文 SHA-256 `4589ef1e948222f8fa3a8076dfd26a495ebfddecb79e7161f6950f779895df81`。**同步状态：** 与该版本一致。若中英文存在语义冲突，以英文原文为准。
> **受众：** 运维人员 · **状态：** 当前
>
