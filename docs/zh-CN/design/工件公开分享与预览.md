...
> **翻译说明：** 本文是[英文原文](../../design/artifact-public-sharing-and-preview.md)的简体中文派生翻译。**同步依据：** 英文原文 SHA-256 `e9266e89a8f955fc0bd4f99fb41dfe74789ce130ac838b8eb882afddccccc6cf`。**同步状态：** 与该版本一致。若中英文存在语义冲突，以英文原文为准。
...
- 取代：unified-artifacts.md §6.2“MVP 策略是经过身份验证的空间
  ...
  重新开放。
- 如下：[unified-artifacts.md](./统一工件.md),
  [worker-run-token.md](./Worker运行令牌.md),
  [界面定位.md](./界面定位.md)
