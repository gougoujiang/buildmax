...
- 实现：[trust-harness.md](./trust-harness.md) §3.3
- 如下：[hook-system.md](./hook-system.md)
- 路线图：[../ROADMAP.md](../../ROADMAP.md)
- created_at: `2026-06-03`

## 1. 目的

[trust-harness.md](./trust-harness.md) §3.3 调用 **持久运行跟踪**
这解释了期间发生的事情
...
- 该记录首先将该目录放在`<BUILDMAX_HOME>/traces/<session_id>/`。
  [local-session-storage.md](./local-session-storage.md) §10 将其移至
