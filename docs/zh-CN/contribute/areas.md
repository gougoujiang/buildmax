...
> **翻译说明：** 本文是[英文原文](../../contribute/areas.md)的简体中文派生翻译。**同步依据：** 英文原文 SHA-256 `115d88193563d76508722a620451050adecbfeae598ddaa15fb5f716d2caf122`。**同步状态：** 与该版本一致。若中英文存在语义冲突，以英文原文为准。
> **读者：** 贡献者 · **状态：** 当前有效
>
...
修改边界前，请阅读[信任保障机制](../../design/trust-harness.md)、[沙箱边界](../../design/sandbox-boundaries.md)和[安全政策](../../../SECURITY.md)。请私下报告漏洞，不要把它变成公开的新手 Issue。
