...
[help/skills-and-subagents.md](../../../../manual/skills-and-subagents.md).
...
这些是服务端 Agent 记录，与 `.buildmax/` 下通过 Markdown 文件定义的工作区 subagent 不同；见 [help/skills-and-subagents.md](../../../../manual/skills-and-subagents.md)。
