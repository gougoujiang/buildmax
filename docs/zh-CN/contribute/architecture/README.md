...
> **翻译说明：** 本文是[英文原文](../../../contribute/architecture/README.md)的简体中文派生翻译。**同步依据：** 英文原文 SHA-256 `ccd7012e325c10b61b59594a8eb53dbcb68c3a359a66fee208cd7242c8b3ef63`。**同步状态：** 与该版本一致。若中英文存在语义冲突，以英文原文为准。
> **受众：** 贡献者 · **状态：** 当前有效

这里描述 BuildMax 当前的工作方式。每篇文档覆盖一个包或子系统，并与代码保持同步：包边界移动或运行时契约改变时，应在同一变更中更新相应文档。

这些结构背后的理由见 [../../design/](../../../design/README.md)。各包在目录树中的位置见 [../repo-layout.md](../repo-layout.md)。
