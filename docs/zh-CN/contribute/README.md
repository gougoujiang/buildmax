...
> **翻译说明：** 本文是[英文原文](../../contribute/README.md)的简体中文派生翻译。**同步依据：** 英文原文 SHA-256 `362daa4b947003ee0ad1aa574a8c3e0e3955fab6e4b6c00cbfe44d4b533880e6`。**同步状态：** 与该版本一致。若中英文存在语义冲突，以英文原文为准。
> **受众：** 贡献者 · **状态：** 当前有效
...
设计记录——决策背后的理由与尚未实现的计划——位于 [../design/](../../design/README.md)。
