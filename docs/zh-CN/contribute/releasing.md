...
> **翻译说明：** 本文是[英文原文](../../contribute/releasing.md)的简体中文派生翻译。**同步依据：** 英文原文 SHA-256 `2c5d7bc463980bf508e80f1566a061cd94fe2fa4af2225f6a379cef24e589005`。**同步状态：** 与该版本一致。若中英文存在语义冲突，以英文原文为准。
> **读者：** 维护者 · **状态：** 当前有效
...
4. 按[安装指南](../../../help/install.md)验证 GitHub 证明。
