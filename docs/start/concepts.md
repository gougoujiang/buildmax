...
| **Project** | The local unit of work a session belongs to: one Git repository including all its worktrees, or one plain folder. It is what `--continue` and the session picker are scoped to. |
