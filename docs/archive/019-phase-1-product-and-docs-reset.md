...
- [design/001-about-portal.md](../design/001-about-portal.md) still centers the older `Workspace / Project / Task` product language
...
1. How much of [design/001-about-portal.md](../design/001-about-portal.md) should be rewritten now versus treated as long-range vision?
