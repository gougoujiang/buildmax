...
Implementation note: this phase has landed in the current codebase. The active
quota path is team-scoped in `internal/service/quota`, with `GET /api/usage`
kept as a personal-team compatibility alias and
`GET /api/teams/{team_id}/usage` as the explicit team route.
...
- checker logic:
  - [internal/service/quota/service.go](../../internal/service/quota/service.go)
- task service integration:
  - [internal/service/task/service.go](../../internal/service/task/service.go)
- portal usage endpoint:
  - [internal/server/handlers/usage.go](../../internal/server/handlers/usage.go)
- usage aggregation:
...
### 3.3 Previous Technical Mismatch

This phase originally tracked a user-scoped quota mismatch. That mismatch has
been resolved in the current code: the quota service checks and reports usage by
`teamID`, and usage aggregation reads through team-owned work.
...
- [internal/core/model](../../internal/core/model)
- [internal/infra/db/quota_usage.go](../../internal/infra/db/quota_usage.go)
- [internal/service/quota/service.go](../../internal/service/quota/service.go)
- [internal/service/task/service.go](../../internal/service/task/service.go)
- [internal/server/handlers/usage.go](../../internal/server/handlers/usage.go)
- [internal/server/handlers/config.go](../../internal/server/handlers/config.go)
- [internal/bootstrap/server.go](../../internal/bootstrap/server.go)
- [portal/src/pages/settings/SpaceSettings.tsx](../../portal/src/pages/settings/SpaceSettings.tsx)

Tests likely affected:

- [internal/service/quota/service_test.go](../../internal/service/quota/service_test.go)
- [internal/server/handlers/usage_test.go](../../internal/server/handlers/usage_test.go)
- [internal/server/handlers/tasks_test.go](../../internal/server/handlers/tasks_test.go)
...
- extending the quota-checker interface used by `internal/service/task`
