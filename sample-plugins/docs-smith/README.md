...
A sample BuildMax plugin bundling two documentation skills.
...
```bash
buildmax plugin validate ./sample-plugins/docs-smith
buildmax plugin publish ./sample-plugins/docs-smith
```
