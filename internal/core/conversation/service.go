...
func (s *Service) startTaskRunner(conversationID, userID string) StartTaskRunner {
...
func (s *Service) listTasksRunner() ListTasksRunner {
...
func (s *Service) getTaskRunner() GetTaskRunner {
	if s.TaskService == nil || s.TaskService.Tasks == nil {
		return nil
	}
...
func (s *Service) continueTaskRunner() ContinueTaskRunner {
	if s.TaskService == nil {
		return nil
	}
