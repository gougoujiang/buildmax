...
// NewGetTaskTool returns a model.Tool that gets one task's detail. If runner is nil, Execute returns "not configured".
func NewGetTaskTool(scopeID string, runner GetTaskRunner) model.Tool {
