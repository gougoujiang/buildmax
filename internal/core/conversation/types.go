...
const (
	...
	// ChannelSystem is used for internal handoff turns, such as completed task results.
	// It is intentionally not included in ValidChannels for external adapters.
