...
var EnvVars = []EnvVar{
	...
	{EnvKeyBuildmaxDatabasePassword, "", "Override for database.password in server.yaml"},
	{EnvKeyBuildmaxMinIOAccessKey, "", "Override for storage.minio.access_key in server.yaml"},
	{EnvKeyBuildmaxMinIOSecretKey, "", "Override for storage.minio.secret_key in server.yaml"},
	{EnvKeyBuildmaxWorkerToken, "", "Override for worker.token in server.yaml; shared secret for /api/worker/*"},
	{EnvKeyBuildmaxConversationAPIKey, "", "Override for conversation.model.api_key in server.yaml"},
