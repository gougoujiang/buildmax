...
func TestTeamHandlers(t *testing.T) {
	...
	teamStore := &testutil.MockTeamStore{
		...
		Members: []entity.TeamMember{
			{TeamID: personalTeamID, UserID: "u1", Role: entity.TeamRoleOwner, CreatedAt: 100},
			{TeamID: sharedTeamID, UserID: "u1", Role: entity.TeamRoleOwner, CreatedAt: 200},
			{TeamID: sharedTeamID, UserID: "u2", Role: entity.TeamRoleMember, CreatedAt: 201},
		},
	}
