...
type startTaskRunnerFunc func(ctx context.Context, input string, agentID *string) (string, string, error)

func (f startTaskRunnerFunc) StartTask(ctx context.Context, input string, agentID *string) (string, string, error) {
	return f(ctx, input, agentID)
}
