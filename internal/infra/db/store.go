...
func New(ctx context.Context, dsn string) (*Store, error) {
	...
	if err := db.WithContext(ctx).AutoMigrate(&userRow{}, &spaceRow{}, &spaceMemberRow{}, &spaceInvitationRow{}, &workflowRow{}, &workflowRevisionRow{}, &workflowRunRow{}, &workflowStepRunRow{}, &issueRow{}, &issueCommentRow{}, &agentRow{}, &agentRevisionRow{}, &taskRow{}, &taskRunRow{}, &artifactRow{}, &artifactShareRow{}, &quotaTierRow{}, &conversationRow{}, &conversationMessageRow{}, &userWebhookKeyRow{}, &loginCodeRow{}, &userRefreshTokenRow{}, &llmCallRow{}, &llmModelRow{}, &auditEventRow{}, &systemGrantRow{}, &pluginRow{}, &pluginReleaseRow{}, &pluginActivationRow{}, &secretRow{}, &taskRunSecretRow{}, &workspaceCheckpointRow{}, &schemaMigrationRow{}); err != nil {
