...
| 你想要 | 阅读 |
|---|---|
| 理解 spaces、issues、tasks 和 runs | [核心概念](核心概念.md) |
| 了解 Agent 实际能做什么 | [工具](工具.md) |
| 查看每个标志和子命令 | [CLI](命令行.md) |
| 添加来自你自己系统的工具 | [MCP](MCP服务器.md) |
| 打包一个 workflow，或委派工作 | [技能与子 Agent](技能与子代理.md) |
| 门控或观察 Agent 的行为 | [钩子](钩子.md) |
| 限制 shell 命令 | [沙箱](沙箱.md) |
| 修复无法正常工作的东西 | [故障排查](故障排查.md) |
| 为一个 space 运行 BuildMax | [Portal 概览](Portal概览.md) |
