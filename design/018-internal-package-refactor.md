...
Architecture guard tests now live in `internal/architecture` and protect the high-level dependency direction plus the rule that new internal type aliases should not be introduced as refactor compatibility shims.
