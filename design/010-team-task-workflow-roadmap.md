...
Before starting Phase 5, the Portal Team management surface was strengthened so Team is not only a backend ownership boundary. Current-team member visibility, invitation, and removal now live in a standalone Team Settings page.
